        ...
        <div className="row gy-3">
          ...
          <div className="col-md-6">
            <input
              ...
              className="form-control"
              name="resume"
              placeholder="Upload a Resume  / CV"
              title=" "
              required=""
...
Write something that defines your personality "
              required=""
...
Write about the skill sets that you have based on your experience "
              required=""
...
What’s special about you or your experience that differentiates you from others"
              required=""
...
Which means are you ok to join at same salary or at a minimum realistic pay increment "
              required=""
...
Anything additional that you want us to know besides all above shared information"
              required=""
          ...
          <div className="col-md-12 text-center">
            <div className="RealToast">
              ...
              <button name="submit" type="submit" className="submit-button">
                SUBMIT
              </button>
            </div>
          </div>
