        ...
        <div className="home-page-container">
          ...
          <div className="first-section-grid-item-1">
            <h2 className="home-main-title">
              ...
              <span className="O">O</span>RLDS
              <br />
              <span className="n">N</span>
              <span className="O">O</span>MAD
              <br />
            </h2>
            <span className="home-desc">
              The World’s only Nomad Community which is a curation of the best
              of platforms for Living & Working from Aspiring Destinations
              across the world.
            </span>
          ...
          <div className="first-section-grid-item-2">
            <div
              ...
              <button
                style={{ width: "80%", margin: "0", borderRadius: "20px" }}
        ...
        <div className="website-panel-container">
          ...
          <div className="website-panel">
            <div className="website-panel-sidebar">
              ...
              <Nav
                id="website-sidebar"
                className="flex-column p-0 website-sidebar">
