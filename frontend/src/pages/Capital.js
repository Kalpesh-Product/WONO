    ...
    return (
        <div className='capital-master'>
            <div className='headingContainer'>
                <h1 className='capital-heading'>We
            ...
            <div className='capital-cards-section'>
                <div className='cards-with-text'>
                    ...
                    <p><span> Get identified and introduced within our network and ecosystem of investors who can support your growth an ambitions.</span></p>
                ...
                <div className='cards-with-text'>
                    ...
                    <div className='plus-icon'>+</div>
                    <p><span> We have curated the best financial services partners for your business who can seamlessly manage your business operations.</span></p>
                </div>
                <div className='cards-with-text'>
                ...
                <div className='cards-with-text'>
                    ...
                    <div className='plus-icon'>+</div>
                    <p><span> Our automated analytics platform will help you identify trends when you may need funds and what type of funds which will help your growth. </span></p>
                </div>
            </div>
            <div className='capital-big-text'>
                <h1>Our software suite amplifies the opportunity for the correct investor such as angel investors, venture capital firms and debt firms to integrate with your company at the most appropriate time regardless of the stage you are which ensure the company does not slow its growth strategy. </h1>
            </div>
