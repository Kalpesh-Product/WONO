  ...
  return (
    <>
      <div className="privacy-container wono-text-spacing pb-5 faq-title fontPoppinsRegular">
        <h3 className="Title-font text-center faq-title ComicFont">
          {" "}
        ...
        <div className="privacy-section">
          ...
          <p>
            Write to us at{" "}
            <a href="mailto:response@wono.co">response@wono.co</a> and we shall
            try and get back to you asap.
          </p>
        </div>
        ...
        <div className="privacy-section">
          ...
          <p>
            ...
            <a href="mailto:hr@wono.co">hr@wono.co</a> or apply from our careers
            age.
          </p>
        </div>
        ...
        <div className="privacy-section">
          ...
          <p>
            ...
            with us via our{" "}
            <Link className="WONOBLUE" to="/contact">
              Contact us
            </Link>{" "}
            page.{" "}
          </p>
