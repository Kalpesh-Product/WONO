    ...
    <>
      <div className="privacy-container wono-text-spacing fontPoppinsRegular">
        ...
        <div className="privacy-section">
          ...
          <br />
          <span>
            By accessing or using the Service, you (&quot;User&quot;, &quot;you&quot;, or &quot;your&quot;) agree to comply with and
        ...
        <div className="privacy-section">
          <h4>2. Eligibility</h4>
          <span>
            To use the Service, you must be at least 18 years of age or have reached the legal age in your
        ...
        <div className="privacy-section">
          ...
          <span>To access certain features of the Service, you must create an account. You agree to provide
            ...
            and for all activities that occur under your account.</span>
          <br />
          <br />
          <span>We reserve the right to suspend or terminate your account if we suspect unauthorized activity
            or if you breach these Terms.</span>
        </div>
        <div className="privacy-section">
          <h4>4. Subscription and Payment</h4>
          <span>
            The Service is available on a subscription basis. By subscribing, you agree to pay the fees
            indicated at the time of subscription, which may vary based on the plan you choose.
          </span>
          <br />
          <br />
          <ul>
            <li><b>Billing Cycle:</b> Subscriptions are billed on a monthly or annual basis, depending on
              your plan.</li>
            <li><b>Automatic Renewal:</b> Subscriptions automatically renew at the end of each billing
              cycle unless you cancel your subscription.</li>
            <li><b>Payment Methods:</b> We accept [list payment methods]. You authorize us to charge
              your selected payment method for all subscription fees.</li>
            <li><b>Refunds:</b>All fees are non-refundable, except where required by law.</li>
          </ul>
        </div>
        <div className="privacy-section">
          ...
          <span>
            ...
            use the Service for your internal business purposes. You agree not to:
          </span>
          <br />
          <br />
          <ul>
            ...
            <li>Misuse the Service, such as by introducing malware, spamming, or disrupting the
              platform.</li>
          </ul>
          <br />
          <span>
            We reserve the right to terminate or restrict your access to the Service if we believe you have
        ...
        <div className="privacy-section">
          ...
          <span>
            All content, materials, trademarks, and technology on the platform, including the software
            and its features, are owned by or licensed to the Company and are protected by intellectual
        ...
        <div className="privacy-section">
          ...
          <span>
            We value your privacy. Our collection, use, and storage of your data are governed by our <span style={{ textDecoration: 'underline', cursor: 'pointer' }} onClick={() => { navigate('/privacy') }}>Privacy Policy</span>. By using the Service, you consent to the collection and use of
        ...
        <div className="privacy-section">
          ...
          <span>
            Our platform may integrate with third-party services. We are not responsible for the
        ...
        <div className="privacy-section">
          ...
          <span>
            We strive to provide continuous access to the Service, but we do not guarantee that the
            Service will be available at all times. The Service may be interrupted for maintenance,
        ...
        <div className="privacy-section">
          ...
          <span>
            We may modify or update the Service, these Terms, or our pricing at any time. We will
            provide notice of significant changes by posting the updated Terms on our platform or by
        ...
        <div className="privacy-section">
          ...
          <span>
            To the fullest extent permitted by law, the Company and its affiliates, officers, employees, or
            agents shall not be liable for any indirect, incidental, special, or consequential damages
        ...
        <div className="privacy-section">
          ...
          <span>
            You agree to indemnify and hold harmless the Company, its affiliates, employees, and agents
            from any claims, liabilities, damages, losses, or expenses arising from your use of the
        ...
        <div className="privacy-section">
          ...
          <span>
            These Terms are governed by the laws of Singapore, without regard to its conflict of law
            principles. Any disputes arising from or related to these Terms or the Service will be resolved
            through binding arbitration in accordance with the rules of the [Arbitration Association], and
        ...
        <div className="privacy-section">
          ...
          <span>
            We will not be liable for any failure or delay in the performance of our obligations due to
        ...
        <div className="privacy-section">
          ...
          <span>
            These Terms, along with our Privacy Policy and any additional agreements or terms you
